...
void Draw(wav_header&  AudioFile) {
	...
	std::cout << glGetString(GL_VERSION) << std::endl;
        ...
        float positions[] = { AudioFile.audiodata[0], AudioFile.audiodata[1], AudioFile.audiodata[2], AudioFile.audiodata[3] };
		...
		while (!glfwWindowShouldClose(window))
		{
			...
			float framedata[]{
                AudioFile.audiodata[samplecount  ], AudioFile.audiodata[samplecount + 1], AudioFile.audiodata[samplecount + 3], AudioFile.audiodata[samplecount + 4]
			};
